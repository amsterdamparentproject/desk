      ...
      <div className="flex items-center justify-between border-t border-slate-50 pt-2 gap-2">
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1.5 bg-slate-50 text-slate-500 rounded-lg hover:bg-slate-100 transition-colors shrink-0"
          >
            <Paperclip size={14} />
          ...
          <button
            ...
            className={`flex items-center gap-1 px-2 py-1.5 rounded-lg transition-colors shrink-0 ${
              useAi ? 'bg-blue-50 text-blue-600 hover:bg-blue-100' : 'bg-slate-50 text-slate-400 hover:bg-slate-100'
            }`}
          >
            <Sparkles size={14} />
            <span className="text-[10px] font-black uppercase tracking-widest whitespace-nowrap">Use AI</span>
          </button>
        ...
        <button
          ...
          className="bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 disabled:bg-slate-50 disabled:text-slate-300 transition-all shadow-md active:scale-95 shrink-0"
        >
