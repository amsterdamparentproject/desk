...
export function Column({ list, isOpen, onToggle, events, onDetails, onMove, onAddEvent }: ColumnProps) {    
  
  // Bridge the InboxForm data to our global event state
    const handleInboxAdd = (data: { id: string; list_id: ListId; description: string; file: File | null }) => {
    onAddEvent({
        id: data.id,
