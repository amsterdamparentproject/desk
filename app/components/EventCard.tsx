    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col transition-all">
      ...
      >
        <span className="text-[10px] font-bold uppercase">
          {isExpanded ? 'Show Less' : 'Edit Details'}
        </span>
      ...
      <div className="p-3 bg-white flex items-center gap-2">
        ...
        <button
          onClick={() =>
            handleChange('add_to_calendar', !event.add_to_calendar)
          }
        ...
        <a
          href={event.url}
          target="_blank"
          className="p-2 text-slate-400 hover:text-blue-500 border border-transparent"
        >
